...
<form method="POST" style="width:300px" class="container">
    <fieldset>
        Books <input type="text" name="notebooks" class="form-control">
        <br><br>
        Describe <input type="text" name="describe" class="form-control">
        <br><br>
        Quantity <input type="text" name="quantity" class="form-control">
        <br><br>
        Category <input type="text" name="category" class="form-control">
        <br><br>
        <input type="submit" value="Creat" class="btn btn-primary">
    </fieldset>
    <?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $bookName = $_POST['notebooks'];
